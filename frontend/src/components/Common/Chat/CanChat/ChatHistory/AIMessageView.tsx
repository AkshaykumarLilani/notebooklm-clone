...
import { AIMessage, scrollAiAnswerIdIntoView } from "@/lib/chat_history_utils"

type AIMessageViewProps = {
    data: AIMessage
}

const AIMessageView = ({ data: { error, loading, citations, sources, message, id } }: AIMessageViewProps) => {
    useEffect(() => {
        if (id) {
