...
const ChatHistory = ({ className }: { className: string }) => {
    ...
    const { chatHistory } = useChatContext() as ChatContextType
    ...
    if (Array.isArray(chatHistory) && chatHistory.length > 0) {
        return (
            <div ref={chatHistoryContainerRef} className={cn(className)}>
        ...
        return (
            <div className={cn(className, "items-center justify-center")}>
